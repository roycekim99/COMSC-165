...
string Save(vector<string> list) {					//Asks users to input file name | Saves al items to the file
	...
	string fileName;
	cout << "What name would you like to save the list under (add extensions)?\n==| ";
...
int main() {
	...
	system("pause");	//pause the console. Visual studio enterprise on windowns 10 tends to auto close after completing run. Can be changed in settings I think...
	return 0;
}